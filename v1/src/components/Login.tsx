...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-dark-bg rounded-lg p-8 border border-gray-700">
        <div className="text-center mb-8">
          <div className="bg-info-blue p-3 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            } border-2 border-transparent focus:border-info-blue`}
          >
            {isLoading ? (
              <>
