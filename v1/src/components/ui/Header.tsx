      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-info-blue p-2 rounded-lg">
              ...
              <div className="flex items-center space-x-2">
                ...
                {userLeagues.length > 1 && (
                  <div className="relative">
                    ...
                    {showLeagueDropdown && (
                      <div className="absolute top-full left-0 mt-1 bg-dark-bg border border-gray-700 rounded-lg shadow-lg z-50 min-w-48">
                        {userLeagues.map((league) => (
                          <button
                            ...
                            className={`w-full text-left px-4 py-2 hover:bg-gray-700 ${
                              league.id === currentLeague?.id ? 'bg-gray-700 text-white' : 'text-gray-300'
                            }`}
                          >
                            <div className="flex items-center space-x-2">
                        ...
                        <div className="border-t border-gray-700 mt-1 pt-1">
                          <Link 
                            ...
                            className="w-full text-left px-4 py-2 hover:bg-gray-700 rounded-b-lg text-info-blue hover:text-accent-cyan flex items-center space-x-2"
                          >
              ...
              <div className="flex items-center space-x-2">
                ...
                {availableSeasons.length > 1 && (
                  <div className="relative">
                    ...
                    {showSeasonDropdown && (
                      <div className="absolute top-full left-0 mt-1 bg-dark-bg border border-gray-700 rounded-lg shadow-lg z-50 min-w-40">
                        {availableSeasons.map((season) => (
                          <button
                            ...
                            className={`w-full text-left px-3 py-2 text-sm hover:bg-gray-700 first:rounded-t-lg last:rounded-b-lg ${
                              season.id === currentSeason?.id ? 'bg-gray-700 text-white' : 'text-gray-300'
                            }`}
                          >
                            {season.name}
                          </button>
              ...
              <>
                <div className="hidden md:flex items-center space-x-3">
                  {currentUser.user_metadata?.avatar_url ? (
                    ...
                    <div className="w-8 h-8 bg-info-blue rounded-full flex items-center justify-center text-white font-medium">
